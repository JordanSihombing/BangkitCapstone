...
public final class BottomSheetLayoutBinding implements ViewBinding {
  ...
  private BottomSheetLayoutBinding(@NonNull LinearLayoutCompat rootView,
      @NonNull LinearLayoutCompat bottomSheet, @NonNull ImageView bottomSheetArrow,
      @NonNull Spinner spnDevice, @NonNull Spinner spnModel, @NonNull Spinner spnTracker,
  ...
  public static BottomSheetLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new BottomSheetLayoutBinding((LinearLayoutCompat) rootView, bottomSheet,
          bottomSheetArrow, spnDevice, spnModel, spnTracker, swPoseClassification,
          tvClassificationValue1, tvClassificationValue2, tvClassificationValue3, tvFps, tvScore,
          vClassificationOption, vTrackerOption);
    }
